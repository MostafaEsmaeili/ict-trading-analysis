...
/// the decided actions and measure the max-hold / no-overnight time-exit without the aggregate ever reading an
/// ambient clock. Self-validating: the time must be UTC.
/// </summary>
